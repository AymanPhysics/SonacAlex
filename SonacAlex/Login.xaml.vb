...
Public Class Login
    ...
    Private Sub btnLogin_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnLogin.Click
        ...
        Md.IsExports2 = IIf(dt.Rows(0)("IsExports2").ToString() = "1", True, False)
        ...
        SaveSetting("SonacAlex", "Login", "AccYear", AccYear.Text)
        SaveSetting("SonacAlex", "Login", "Username", Username.Text)
    End Sub
    ...
    Private Sub Login_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Else
            ...
            Dim MyAccYear As String = GetSetting("SonacAlex", "Login", "AccYear")
            If MyAccYear = "" Then
    ...
    Private Sub LoadEmployees()
        ...
        Username.Text = GetSetting("SonacAlex", "Login", "Username")
