...
Public Class Booking
    Public TableName As String = "Booking"
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.FillCombo("select Id, EnName Name from Items where IsExports=1 union select 0,'-'", ItemId)


        LoadResource()
        bm.Fields = New String() {MainId, SubId, SubId2, "DayDate", "Canceled", "IsPosted", "ShippingMethodId", "NoOfContainers", "ShippingInvoiceNo", "PortId", "CountryId", "ShippingLineId", "ForwarderId", "TruckerId", "StationId", "VarietyId", "PrimaryFreight", "ToPortId", "DayDate2", "DayDate3", "DayDate6", "DayDate7", "DayDate9", "BillNo", "FileNo", "ItemId", "Notes"}
        bm.control = New Control() {CustomerId, txtFlag, txtID, DayDate, Canceled, IsPosted, ShippingMethodId, NoOfContainers, ShippingInvoiceNo, PortId, CountryId, ShippingLineId, ForwarderId, TruckerId, StationId, VarietyId, PrimaryFreight, ToPortId, DayDate2, DayDate3, DayDate6, DayDate7, DayDate9, BillNo, FileNo, ItemId, Notes}
